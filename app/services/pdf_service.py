...
<body>
    ...
    <div class="footer-bar">
        &copy; {time.strftime('%Y')} &nbsp;|&nbsp; This document was generated by AI and is legally binding between the signing parties. &nbsp;|&nbsp; Confidential &mdash; For authorized parties only
    </div>
</body>
</html>"""
